...
Predictor Variables:
* big_tree_count:       Number of mature trees within the stand
...
* total_tree_count:   Number of trees within the stand
...
SR_mt_predplot <- 
  ...
  geom_ribbon(aes(ymin = conf.low,
              ...
              linetype=2,
              alpha=0.25) +
  xlab("Number of mature trees within a stand") +
  ylab("Richness") +
  ylim(0,10) +
  theme_bw()
...
HAb_area_predplot_conditional
```
### 5.4.2. HAb - Mature trees within a stand
#### 5.4.21 HAb - Mature trees within a stand (generating predictions)
```{r}
# New data
...
#### 5.4.2b HAb - Mature trees within a stand (Probability of a zero)
```{r}
...
#### 5.4.2c HAb - Mature trees within a stand (Non-zero abundances - conditional)
```{r}
...
# 6. Arranging and Formatting Plots for Publication or Presentations
## 6.1. SR
```{r}
...
# jpegs
# Figure 1
ggsave("./analysis_outputs/result_plots/Fig1_SRnAB_plot.jpg", 
       plot = SRnAB_presplots, 
       width = 12, height = 8,
       bg = "white")

# Figure 2
ggsave("./analysis_outputs/result_plots/Fig2_HSR_plot.jpg", 
       plot = HSR_presplots_ann,
       width = 12, height = 4,
       bg = "white")
...
# Figure 3
ggsave("./analysis_outputs/result_plots/Fig3_HAb_plot.jpg", 
       plot = HAb_presplots_ann,
       width = 12, height = 18,
       bg = "white")
